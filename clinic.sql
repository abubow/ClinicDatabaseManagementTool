...
Alter table Schedules add foreign key Schedules(Doctor_Id) References Doctor(Doctor_Id);
 insert into Schedules (Schedule_Id,Doc_Sche_Date,Doc_Sche_Time ,Doc_Sche_Desc)
						values('032','2022-12-21','5:30','Monthly Checkup'),
							 ('32115','2022-12-22','5:30','Physiotherapy'),
							 ('21144','2022-12-23','5:30','Psych Eval'),
							 ('44558','2022-12-23','6:00','Psych Eval'),
							 ('01478','2022-12-24','5:30','Chemo Therapy');
